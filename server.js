...
// This section will provide the code for adding employees, roles and departments
    ...
    inquirer
        ...
        .then((answer) => {
            ...
            connection.query(sql, answer.newDepartment, (error, response) => {
                if (error) throw error;
                console.log(``);
                console.log(chalk.blue(answer.newDepartment + ` Department successfully created!`));
                console.log(``);
                viewAllDepartments();
            });
        });
...
// This section will provide the code for updating the employees, roles and departments
                ...
                .then((answer) => {
                    ...
                    connection.query(
                        ...
                        (error) => {
                            if (error) throw error;
                            console.log(chalk.blue.bold(`====================================================================================`));
                            console.log(chalk.blue(`Employee Role Updated`));
                            console.log(chalk.blue.bold(`====================================================================================`));
                            promptUser();
                        }
                    );
...
// This section will provide the code for removing the employees, roles and departments
        ...
        inquirer
            ...
            .then((answer) => {
                ...
                connection.promise().query(sql, [roleId], (error) => {
                    if (error) throw error;
                    console.log(chalk.redBright.bold(`====================================================================================`));
                    console.log(chalk.blue(`Role Successfully Removed`));
                    console.log(chalk.redBright.bold(`====================================================================================`));
                    viewAllRoles();
                });
            });
